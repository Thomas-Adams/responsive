...
(function($, window, document, undefined){
	...
	$.widget("ui.ioSimplePageTransition",  {
		...
		_init : function(){
			var $elem = $(this.element), wh = window.innerHeight;
		...
		_create : function() {
			var wh = window.innerHeight, self = this,
				$elem = $(this.element),
		...
		navigateTo: function(index) {
			...
			var  $elem=$(this.element), e = $elem.find(this.options.pageSelector).eq(index), wh = window.innerHeight;
			this._loadCurrent(e);
